      ...
      <Table>
        <TableHeader>
          <TableRow className="border-white/10 bg-white/5">
            <TableHead className="text-white w-[160px]">Serial Number</TableHead>
            <TableHead className="text-white">Mission Type</TableHead>
            <TableHead className="text-white w-[120px]">Facility</TableHead>
            <TableHead className="text-white text-left w-[120px]">{metricName}</TableHead>
            <TableHead className="text-white text-right w-[100px]">Status</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {data.length === 0 ? (
