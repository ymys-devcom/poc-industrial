      ...
      {isMobile ? (
        <main className="px-4 pb-6 pt-[10px] overflow-y-auto flex-1">
          <h1 className="text-xl font-bold text-white flex items-center mb-[10px]">
            ...
            {getMetricDetails(metricId || "").title}
          </h1>
          ...
          <div className="space-y-6 w-full max-w-full">
            <div className="backdrop-blur-md border-white/10 rounded-lg">
                  ...
                  >
                    ...
                    <div className="border-t border-white/10 pt-2">
                      <p className="text-white/60 text-xs">
                        {getMetricDetails(metricId || "").isAccumulative ? "Total" : "Average"}
                      </p>
              ...
              <DataTable 
                data={robotData} 
                metricName={getMetricDetails(metricId || "").title}
                isPercentage={getMetricDetails(metricId || "").isPercentage}
              />
            </div>
          </div>
        </main>
        ...
        <ScrollArea className="flex-1">
          <main className="px-6 pb-6 pt-6 overflow-hidden">
            <Button 
